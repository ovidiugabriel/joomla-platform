...
abstract class JLoader
{
	 ...
	 *
	 * @return  boolean  True on success
	 * @proto static public load(className:String):Bool
	 *
	 * @since   11.1
	 */
	 ...
	 * @proto static public loadByNamespaceLowerCase(className:String):Bool
	 *
	 * @since   12.3
	 */
	 ...
	 *
	 * @return  boolean  True on success, false otherwise.
	 * @proto static public loadByNamespaceNaturalCase(className:String):Bool
	 *
	 * @since   12.3
	 */
	 ...
	 *
	 * @return  boolean  True on success, false otherwise.
	 * @proto static public loadByNamespaceMixedCase(className:String):Bool
	 *
	 * @since   12.3
	 */
	 ...
	 *
	 * @return  void
	 * @proto static public register(className:String, path:String, ?force:Bool):Void
	 *
	 * @since   11.1
	 */
